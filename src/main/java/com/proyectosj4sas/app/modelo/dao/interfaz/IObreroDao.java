...
public interface IObreroDao extends CrudRepository<Obrero, Long> {
	...
	@Query(value = "{call lista_obreros_sin_arl(:idIn)}", nativeQuery = true) //retorna los que no tienen arl, pero hay un problema: si todos tienen arl entonces me retorna query nula y me bota error para el excel.
